 ...
 */
final class Version20180510161409 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE store_category (id INTEGER NOT NULL, store_id INTEGER NOT NULL, category_id INTEGER NOT NULL, url VARCHAR(255) NOT NULL, product_list_query VARCHAR(255) NOT NULL, next_page_query VARCHAR(255) NOT NULL, product_name_query VARCHAR(255) NOT NULL, product_price_query VARCHAR(255) DEFAULT NULL, product_image_query VARCHAR(255) DEFAULT NULL, product_url_query VARCHAR(255) NOT NULL, product_ean_query VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_383B663BB092A811 ON store_category (store_id)');
        $this->addSql('CREATE INDEX IDX_383B663B12469DE2 ON store_category (category_id)');
        ...
        $this->addSql('CREATE TABLE product_price (id INTEGER NOT NULL, product_id INTEGER NOT NULL, store_id INTEGER NOT NULL, price INTEGER NOT NULL, date DATE NOT NULL, url VARCHAR(255) DEFAULT NULL, html_location VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_6B9459854584665A FOREIGN KEY (product_id) REFERENCES product (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6B945985B092A811 FOREIGN KEY (store_id) REFERENCES store (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
